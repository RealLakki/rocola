    ...
    >
      {glow && (
        <div
          ...
          style={{
            background:
              'radial-gradient(circle, rgb(var(--b1) / 0.7) 0%, rgb(var(--b2) / 0.3) 45%, transparent 72%)',
          }}
        />
      )}
      <svg viewBox="0 0 64 64" width="100%" height="100%" fill="none" className="relative w-full h-full">
        <defs>
          <linearGradient id={`g-${id}`} x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="rgb(var(--b1-light))" />
            <stop offset="55%" stopColor="rgb(var(--b1))" />
            <stop offset="100%" stopColor="rgb(var(--b2))" />
          </linearGradient>
        ...
        {/* Surcos */}
        <circle cx="32" cy="32" r="24" fill="none" stroke="rgb(var(--b1) / 0.25)" strokeWidth="1" />
        <circle cx="32" cy="32" r="19" fill="none" stroke="rgb(var(--b2) / 0.20)" strokeWidth="1" />
